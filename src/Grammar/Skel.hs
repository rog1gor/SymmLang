...
transStmt x = case x of
  Grammar.Abs.Decl _ type_ item -> failure x
  Grammar.Abs.ReadDecl _ type_ ident expr -> failure x
  ...
  Grammar.Abs.For _ ident expr1 expr2 block -> failure x
  Grammar.Abs.FnDef _ type_ ident arguments block -> failure x
...
transArgument :: Show a => Grammar.Abs.Argument' a -> Result
transArgument x = case x of
  Grammar.Abs.Arg _ ident -> failure x
