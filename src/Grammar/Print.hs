...
instance Print (Grammar.Abs.Stmt' a) where
  prt i = \case
    Grammar.Abs.Decl _ type_ item -> prPrec i 0 (concatD [doc (showString "Let"), prt 0 type_, prt 0 item])
    Grammar.Abs.ReadDecl _ type_ id_ expr -> prPrec i 0 (concatD [doc (showString "Read"), prt 0 type_, prt 0 id_, doc (showString "="), prt 0 expr])
    Grammar.Abs.Ass _ id_ expr -> prPrec i 0 (concatD [prt 0 id_, doc (showString "="), prt 0 expr])
    Grammar.Abs.Ret _ expr -> prPrec i 0 (concatD [doc (showString "return"), prt 0 expr])
    Grammar.Abs.Cond _ expr block -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block])
    Grammar.Abs.CondElse _ expr block1 block2 -> prPrec i 0 (concatD [doc (showString "eif"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block1, doc (showString "else"), prt 0 block2])
    ...
    Grammar.Abs.For _ id_ expr1 expr2 block -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 id_, doc (showString "in"), prt 0 expr1, doc (showString "..."), prt 0 expr2, doc (showString ")"), prt 0 block])
    Grammar.Abs.FnDef _ type_ id_ arguments block -> prPrec i 0 (concatD [doc (showString "Fun"), prt 0 type_, prt 0 id_, doc (showString "("), prt 0 arguments, doc (showString ")"), prt 0 block])
    Grammar.Abs.Print _ exprs -> prPrec i 0 (concatD [doc (showString "Print"), doc (showString "("), prt 0 exprs, doc (showString ")")])
...
instance Print (Grammar.Abs.Argument' a) where
  prt i = \case
    Grammar.Abs.Arg _ id_ -> prPrec i 0 (concatD [prt 0 id_])
...
instance Print (Grammar.Abs.Type' a) where
  prt i = \case
    ...
    Grammar.Abs.FunT _ -> prPrec i 0 (concatD [doc (showString "FunT")])
