...
data Stmt' a
    ...
    | ReadDecl a (Type' a) Ident (Expr' a)
    | Ass a Ident (Expr' a)
    | Ret a (Expr' a)
...
type Argument = Argument' BNFC'Position
data Argument' a = Arg a Ident
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Type = Type' BNFC'Position
data Type' a = Int a | Str a | Bool a | FunT a
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
instance HasPosition Argument where
  hasPosition = \case
    Arg p _ -> p
